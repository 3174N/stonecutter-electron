 ...
 * @license Apache-2.0
 *
 * Copied into src/styles/ from node_modules/
 */
    ...
    ***************************************************************************** */
    ...
    ImportVisitor.prototype = {
        ...
        onImported: function (
            ...
            var importVisitor = this,
                ...
                duplicateImport =
                    importedAtRoot ||
                    fullPath in importVisitor.recursionDetector;
    ...
    var ProcessExtendsVisitor = /** @class */ (function () {
        ...
        ProcessExtendsVisitor.prototype.visitRuleset = function (
            ...
            var pathIndex;
            var extendIndex;
            var allExtends = this.allExtendsStack[
            ...
            SourceMapOutput.prototype.add = function (
                ...
                if (fileInfo && fileInfo.filename) {
                    ...
                    if (this._contentsIgnoredCharsMap[fileInfo.filename]) {
                        // adjust the index
                        index -= this._contentsIgnoredCharsMap[
                            fileInfo.filename
                        ];
                        if (index < 0) {
                            index = 0;
